...
def mergesort3(lst: List) -> List:
    ...
    >>> mergesort3([-10])
    [-10]
    >>> mergesort3([-1, 10, 6, 8, 9, 6, 0, -9, 2])
    [-9, -1, 0, 2, 6, 6, 8, 9, 10]
    >>> mergesort3([7, 7, -6, 5, 0, 5, 0, 3, 1, 2, 3, 4, 5, 10, 100, -100])
    [-100, -6, 0, 0, 1, 2, 3, 3, 4, 5, 5, 5, 7, 7, 10, 100]
    >>> mergesort3([-10, 6, 7, 5, 0, 0, -1])
    [-10, -1, 0, 0, 5, 6, 7]
    >>> mergesort3([-10, 6, 7, 5, 0, 5, 0, 3, 1, 2, 3, 4, 5, 10, 100, -100])
    [-100, -10, 0, 0, 1, 2, 3, 3, 4, 5, 5, 5, 6, 7, 10, 100]
    """
    if len(lst) < 2:
        return lst[:]
    elif len(lst) == 2:
        ...
        left_sorted = mergesort3(lst[:div_1])
        mid_sorted = mergesort3(lst[div_1:div_2])
        right_sorted = mergesort3(lst[div_2:])
...
def merge3(lst1: List, lst2: List, lst3: List) -> List:
    ...
    if index1 == len(lst1) and index2 == len(lst2) and index3 < len(lst3):
        merged.extend(lst3[index3:])
    if index2 == len(lst2) and index3 == len(lst3) and index1 < len(lst1):
        merged.extend(lst1[index1:])
    if index1 == len(lst1) and index3 == len(lst3) and index2 < len(lst2):
...
def kth_smallest(lst: List, k: int) -> Any:
    ...
    -4
    >>> kth_smallest([12, 3, 5, 7, 4, 19, 26], 4)
    12
    >>> kth_smallest([12, 3, 5, 7, 4, 19, 26], 0)
    3
    >>> kth_smallest([12, 3, 5, 7, 4, 19, 26], 1)
    4
    >>> kth_smallest([12, 3, 5, 7, 4, 19, 26], 2)
    5
    >>> kth_smallest([12, 3, 5, 7, 4, 19, 26], 3)
    7
    >>> kth_smallest([12, 3, 5, 7, 4, 19, 26], 4)
    12
    >>> kth_smallest([12, 3, 5, 7, 4, 19, 26], 5)
    19
    >>> kth_smallest([12, 3, 5, 7, 4, 19, 26], 6)
    26
    ...
    if k < 0 or k >= len(lst):
        ...
        small, big = _partition(lst[1:], lst[0])
        if k == 0 and len(small) == 1:
            return small[0]
        if k == 0 and len(small) == 0:
            return lst[0]
        if len(small) == 0 and k == 1:
            return kth_smallest(big, 0)
        if len(small) < k:
